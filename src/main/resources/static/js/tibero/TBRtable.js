		...
		, success : function(data){
			...
			let result = 
				...
				$.each(data, function(key, value){
					...
					const dataLength = value.dataLength;
			...
			result += 
				...
				<div class="d-grid gap-3 d-sm-flex justify-content-sm-end mb-3">
					<button type="button" id="btnExcel" class="btn btn-outline-primary" onclick="excelDownload('${owner}', '${tableName}');">EXCEL</button>
					<button type="button" id="btnCsv" class="btn btn-outline-success" onclick="csvDownload('${owner}', '${tableName}');">CSV</button>
					...
					<tbody>
						...
						<tr>
							...
							<th scope="col">
								...
								<label class="btn btn-outline-primary" for="columnComment">속성명</label>
							</th>
							<th scope="col">
								<input type="checkbox" class="btn-check" id="columnName" name="columnName" value="columnName" autocomplete="off">
								<label class="btn btn-outline-primary" for="columnName">컬럼명</label>
							</th>
							<th scope="col">
